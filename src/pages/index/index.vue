        ...
        <view class="courseList">
            <view class="courseLi" v-for="(item, i) in list" :key="i">
                <view @click="gotoDetailType(item)">
                    ...
                    <view class="info">
                        ...
                        >
                            ...
                            <image
                                ...
                                src="/static/time.png"
                                @error="imageError"
                                v-if="[3, 4, 5, 6, 7, 8, 10].includes(item.status)"
                            />
                            <text
                                ...
                                v-if="
                                    item.type === 1 &&
                                    item.status === 9 &&
                                    (!hasTeacher(item.sessionFrom) || (hasTeacher(item.sessionFrom) && item.sendTchCode === 1))
                                "
                            >
                    ...
                    <view
                        v-else-if="
                            item.type === 1 && item.status === 9 && (!hasTeacher(item.sessionFrom) || (hasTeacher(item.sessionFrom) && item.sendTchCode === 1))
                        "
                        id="index_gotoclass_click"
                        :data-coursetype="item.type"
                        :data-status="item.status"
